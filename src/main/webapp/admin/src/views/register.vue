  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(0, 0, 0, 1);fontSize:28px;">医院预约挂号系统注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210321/47ee3a4b0ab54700ba54af6045ed9a80.jpg");
		height: 100vh;
