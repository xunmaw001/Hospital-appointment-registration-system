<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投诉对象" prop="tousuduixiang">
          <el-input v-model="ruleForm.tousuduixiang" 
              placeholder="投诉对象" clearable  :readonly="ro.tousuduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投诉对象" prop="tousuduixiang">
              <el-input v-model="ruleForm.tousuduixiang" 
                placeholder="投诉对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="处理进度" prop="chulijindu">
        ...
        <div v-else>
          <el-form-item class="input" label="处理进度" prop="chulijindu">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理反馈" prop="chulifankui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chulifankui" label="处理反馈" prop="chulifankui">
                    <span>{{ruleForm.chulifankui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='tousuduixiang'){
            this.ruleForm.tousuduixiang = obj[o];
	    this.ro.tousuduixiang = true;
            continue;
          }
          if(o=='tousuneirong'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.chulijinduOptions = "处理中,已完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
