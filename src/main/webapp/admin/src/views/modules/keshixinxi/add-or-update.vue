<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂号人数" prop="guahaorenshu">
          <el-input v-model="ruleForm.guahaorenshu" 
              placeholder="挂号人数" clearable  :readonly="ro.guahaorenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="挂号人数" prop="guahaorenshu">
              <el-input v-model="ruleForm.guahaorenshu" 
                placeholder="挂号人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhibanbiao = this.ruleForm.zhibanbiao.replace(reg,'../../../ssm3e3g0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
