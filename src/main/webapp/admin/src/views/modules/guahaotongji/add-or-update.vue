    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="科室名称" prop="keshimingcheng">
          <el-select  @change="keshimingchengChange" v-model="ruleForm.keshimingcheng" placeholder="请选择科室名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约人数" prop="yuyuerenshu">
          <el-input v-model="ruleForm.yuyuerenshu" 
              placeholder="预约人数" clearable  :readonly="ro.yuyuerenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约人数" prop="yuyuerenshu">
              <el-input v-model="ruleForm.yuyuerenshu" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接诊人数" prop="jiezhenrenshu">
          <el-input v-model="ruleForm.jiezhenrenshu" 
              placeholder="接诊人数" clearable  :readonly="ro.jiezhenrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接诊人数" prop="jiezhenrenshu">
              <el-input v-model="ruleForm.jiezhenrenshu" 
                placeholder="接诊人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yishengxingming = true;
          ...
          if(o=='yuyuerenshu'){
            this.ruleForm.yuyuerenshu = obj[o];
	    this.ro.yuyuerenshu = true;
            continue;
          }
          if(o=='jiezhenrenshu'){
            this.ruleForm.jiezhenrenshu = obj[o];
	    this.ro.jiezhenrenshu = true;
            continue;
          }
          if(o=='riqi'){
    ...
    keshimingchengChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              if(data.data.keshiweizhi){
                this.ruleForm.keshiweizhi = data.data.keshiweizhi
              }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `guahaotongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.guahaotongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
