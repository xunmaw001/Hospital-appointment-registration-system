<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维护员" prop="weihuyuan">
          <el-input v-model="ruleForm.weihuyuan" 
              placeholder="维护员" clearable  :readonly="ro.weihuyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维护员" prop="weihuyuan">
              <el-input v-model="ruleForm.weihuyuan" 
                placeholder="维护员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weihushijian = true;
          ...
          if(o=='weihuyuan'){
            this.ruleForm.weihuyuan = obj[o];
	    this.ro.weihuyuan = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xitongweihu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xitongweihuCrossAddOrUpdateFlag = false;
                  this.parent.search();
